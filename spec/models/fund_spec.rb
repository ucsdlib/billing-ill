...
describe Fund do 
  ...
  it {should validates_length_of(:program_code)}
  it {should validates_length_of(:org_code)}
  it {should validates_length_of(:index_code)}
  it {should validates_length_of(:fund_code)}
end